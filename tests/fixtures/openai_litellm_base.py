...
class OpenAI_LiteLLM_Test_Base(BaseProviderUtils):
    ...
    def test_set_request_attributes_delegation(self):
        ...
        self.set_request_attributes_method(mock_span, kwargs_chat, "chat")
        ...
        self.set_request_attributes_method(mock_span, kwargs_resp, "response")
        mock_span.set_attribute.assert_any_call(f"{SpanAttributes.LLM_PROMPTS}.0.role", "user")
    ...
    def test_set_request_attributes_special_fields(self):
        ...
        self.set_request_attributes_method(mock_span, kwargs, "chat")
